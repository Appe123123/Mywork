...
#Source 1: https://github.com/cstria0106/Self-driving-Car/blob/master/src/process.py
#Source 2: https://medium.com/@mrhwick/simple-lane-detection-with-opencv-bfeb6ae54ec0
...
while True:
    ...
    cannyed_frame = cv2.Canny(gray_frame,100, 200)
    ...
    cv2.imshow("iii", tmp.get('image', None)) 
    
    angle = tmp.get('angle', None)
